...
``` {r libreria readxl, warning = FALSE, echo = FALSE}
if (!requireNamespace("readxl", quietly = TRUE)) {install.packages("readxl")}
library(readxl)
```

``` {r descargar 2, warning = FALSE}
...
```{r libreria lubridate, warning = FALSE, echo=FALSE}
...
```{r libreria dplyr, warning = FALSE, echo=FALSE}
if (!requireNamespace("dplyr", quietly = TRUE)) {install.packages("dplyr")}
library(dplyr)
```

```{r creación de nuevo dataset 2, warning = FALSE}
...
```{r libreria ggplot2, warning = FALSE, echo=FALSE}
